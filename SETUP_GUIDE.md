...
It fetches prices directly, adds news titles from the last 24 hours using free RSS search, applies rule-based guidance, sends the briefing to Telegram, and saves a markdown copy under `briefings/`.
